...
export function About() {
  return (
    ...
    <div className="z-10 lg:w-[90%] sm:w-[100%] min-h-[20rem] p-[0.4rem] rounded-2xl bg-[#b15ef96f] mt-[1.5rem]">
      ...
      <div className=" w-full relative">
        <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-blue-500 to-teal-500 transform scale-[0.80] bg-red-500 rounded-full blur-3xl" />
            <div className="relative shadow-xl bg-gray-900 border border-gray-800  px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-wrap justify-center items-center">
                ...
                <h1 className="font-bold pb-[0.5rem] text-3xl bg-clip-text text-transparent drop-shadow-2xl bg-gradient-to-b from-[#f0fffb] to-[#fa59ef]"> About Me</h1>

                <span className="font-medium lg:text-sm text-xs text-center text-[#d0e0eeed]">
                ...
                <h1 className="font-bold pt-[1rem] pb-[0.5rem] text-3xl bg-clip-text text-transparent drop-shadow-2xl bg-gradient-to-b from-[#f0fffb] to-[#fa59ef]"> About This Project</h1>

                <span className="font-medium lg:text-sm text-xs text-center text-[#d0e0eeed]">
                    This project includes solutions for the famous UI Challenges available at <a href="https://www.frontendmentor.io/" target="_blank" className="font-medium italic text-[#ba7cc9]">Frontend Mentor</a>. It is created to develop 
